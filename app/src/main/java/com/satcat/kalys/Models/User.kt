...
open class User(
    ...
    fun giveJson(): JSONObject {
        ...
        userJson.put("Image", ImageStorageManager.shared.convertBitmapToString(getImage())) //get Image
        userJson.put("Token", DeviceToken)
        userJson.put("IsAndroid", true)
    ...
    fun setFromJSON(obj: JSONObject) {
        ...
        this.DeviceToken = obj.getString("Token")
